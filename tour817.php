        ...
        <div class="row rt-breadcump-height">
            <div class="col-12">
                <div class="breadcrumbs-content">
                    <h3>TOUR NO: 817 – KOLKATA – 3 NIGHTS 4 DAYS</h3>
                    <div class="breadcrumbs">
                        <span class="divider"><i class="icofont-home"></i></span>
                        <a href="index.php" title="Home">Home</a>
                        <span class="divider"><i class="icofont-simple-right"></i></span>
                        TOUR NO: 817 – KOLKATA – 3 NIGHTS 4 DAYS
...
<section class="blog-content-area">
    ...
    <a href="#" class="post-thumbnail">
        <img src="assets/images/tour/9-big.png" alt="">
        <div class="meta-date">
            <span>22</span>
            <span>Dec</span>
        </div><!-- /.meta-date -->
    ...
    <div class="entry-content">
        <header class="entry-header">
			...
			<p>
				<p><strong>DAY 01 KOLKATA…OVERNIGHT STAY AT KOLKATA</strong></p>
				...
				<p><strong>DAY 02 KOLKATA…OVERNIGHT STAY AT KOLKATA</strong></p>

				Sightseeing BBD Bagh (Dalhousie Square), Botanical Gardens, Rabindra Sarobar & Ramakrishna Mission, Indian Musuem, Maidan & Fort William, Observatory, Eden Gardens, Victoria Memorial, St. Paul’s Cathedral, Birla Planetarium, Kali temple, Howrah Bridge and Belur Math.

				<p><strong>DAY 03 KOLKATA…OVERNIGHT STAY AT KOLKATA</strong></p>

				“ Free and Leisure Tour “ Based on operational possibilities, Vehicle will be provided for Guest’s own choice of programmes i.e. sightseeing, shopping, entertainment, village tour, meeting friends & relatives and cultural programmes like dance, music, cinema, etc.Vehicle is provided for the whole day at Guest’s disposal. Overnight Stay Kolkata

				<p><strong>DAY 04 KOLKATA</strong></p>
