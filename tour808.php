        ...
        <div class="row rt-breadcump-height">
            <div class="col-12">
                <div class="breadcrumbs-content">
                    <h3>TOUR NO 808 - Varanasi | Kashi - 4 DAYS</h3>
                    <div class="breadcrumbs">
                        <span class="divider"><i class="icofont-home"></i></span>
                        <a href="index.php" title="Home">Home</a>
                        <span class="divider"><i class="icofont-simple-right"></i></span>
                        TOUR NO 808 - Varanasi | Kashi - 4 DAYS
...
<section class="blog-content-area">
    ...
    <a href="#" class="post-thumbnail">
        <img src="assets/images/tour/8-big.png" alt="">
        <div class="meta-date">
            <span>22</span>
            <span>Dec</span>
        </div><!-- /.meta-date -->
    ...
    <div class="entry-content">
        <header class="entry-header">
			...
			<p>
				<p><strong>DAY 01 VARANASI OVERNIGHT STAY AT VARANASI</strong></p>
				...
				<p><strong>DAY 02 VARANASI OVERNIGHT STAY AT VARANASI</strong></p>

				Sightseeing Great temple of Lord siva, one of the 12 Jyothir linga, Great Ganga the holiest river, Great Mosque of Aurangazeb, Durga temple, Tulsi Manas temple, Benares Hindu University, Vishwanath temple, Sarnath Buddhist temple and Bharat Mata temple.

				<p><strong>DAY 03 ALLAHABAD OVERNIGHT STAY AT ALLAHABAD</strong></p>

				Drive Varanasi to Allahabad 4 Hrs to have Boat Ride in the holy rivers flowing together in Allahabad known river Ganga, Yamuna and Saraswathy and have Dharshan and offer Prayer at three holy rivers meeting point known popularly as Thiruveni Sangam.

				<p><strong>DAY 04 ALLAHABAD</strong></p>
